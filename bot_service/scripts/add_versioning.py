...
models_to_update = [
    ('TTSUserSettings', 'filter_mentions = Column(Boolean, nullable=False, default=False)  # Фильтровать упоминания (@username)'),
    ('ChatBoxSettings', 'show_7tv_emotes = Column(Boolean, default=True)  # Показывать смайлики 7TV'),
