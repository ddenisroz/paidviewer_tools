...
class DatabaseCleanupService:
    ...
    def __init__(self, db: Session):
        ...
        logger.info(f"[STATS] Database cleanup settings: MAX_PER_USER={self.MAX_CHAT_MESSAGES_PER_USER}, "
    ...
    def cleanup_old_data(self) -> Dict[str, int]:
        ...
        try:
            ...
            if total_messages > self.MAX_TOTAL_CHAT_MESSAGES:
                ...
                logger.info(f"[DELETE] Deleted {excess_count} excess messages to maintain total limit ({self.MAX_TOTAL_CHAT_MESSAGES})")
    ...
    def restore_from_backup(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                if result.returncode == 0:
                    logger.info(f"[OK] PostgreSQL database restored from {latest_backup}")
                    return {
                        'success': True,
