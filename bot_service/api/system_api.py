...
async def generate_api_key(
    ...
    """Р РЋР С–Р ВµР Р…Р ВµРЎР‚Р С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ Р Р…Р С•Р Р†РЎвЂ№Р в„– API Р С”Р В»РЎР‹РЎвЂЎ Р Т‘Р В»РЎРЏ Р С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЏ"""
    try:
...
async def get_system_logs(
    ...
    try:
        ...
        all_logs.sort(reverse=True)  # Р СњР С•Р Р†РЎвЂ№Р Вµ РЎРѓР Р†Р ВµРЎР‚РЎвЂ¦РЎС“
        ...
        if not result_logs:
            return {
                ...
                "logs": [
                    ...
                    "INFO - Р вЂєР С•Р С–Р С‘ РЎРѓР С•РЎвЂ¦РЎР‚Р В°Р Р…РЎРЏРЎР‹РЎвЂљРЎРѓРЎРЏ Р Р† Р С—Р В°Р С—Р С”Р Вµ bot_service/logs/",
                    "INFO - Р СџРЎР‚Р С•Р Р†Р ВµРЎР‚РЎРЉРЎвЂљР Вµ РЎвЂћР В°Р в„–Р В»РЎвЂ№: logs/app/bot_service.log Р С‘ logs/errors/bot_service_errors.log"
                ],
                "total_lines": 3,
