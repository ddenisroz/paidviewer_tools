            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="bg-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Активные сессии</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <Card className="bg-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Обработано сообщений</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Активность в чате</p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Подключений Twitch/VK</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Card className="bg-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Каналов с активным ботом</p>
                ...
                <Card className="bg-muted border-border">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Запросов синтеза речи</p>
