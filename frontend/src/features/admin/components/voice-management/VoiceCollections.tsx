...
const VoiceCollections: React.FC<VoiceCollectionsProps> = ({
  ...
  <Card className={SURFACE_CARD_CLASS}>
    ...
    <CardContent>
      {!isAdminVoiceAvailable ? (
        <WarningBanner
          title="Операции с голосами недоступны"
          tone="border-sky-500/40 bg-sky-500/10 text-sky-100/90"
          message={providerCapabilityMessage || 'Для выбранного провайдера недоступно админское управление голосами.'}
      ...
      {ttsServiceWarning ? (
        <WarningBanner
          ...
          hint="Проверьте upstream-конфигурацию в bot_service и доступность выбранного провайдера или шлюза."
