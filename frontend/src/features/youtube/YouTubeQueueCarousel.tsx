          ...
          <div className="divide-y divide-zinc-800/50">
            {queue.length === 0 ? (
              <div className="p-8 text-center">
                <YouTubeIcon className="w-12 h-12 mx-auto mb-3 text-zinc-700" />
                <p className="text-zinc-400 font-medium mb-1">Очередь пуста</p>
                <p className="text-zinc-500 text-sm">Добавьте YouTube видео, чтобы начать</p>
                {!showAddForm && (
                  <Button
              ...
              visibleQueue.map((video: YouTubeVideo, index: number) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {index === 0 && (
                      <span className="text-[10px] text-zinc-500 uppercase tracking-wide">Up next</span>
                    )}
                    <h4 className="text-sm text-zinc-200 truncate leading-tight" title={video.title}>
                      {video.title}
                    </h4>
                  ...
                  <div className="flex-shrink-0 text-right min-w-[80px]">
                    ...
                    <p className="text-xs text-zinc-400">{video.requester_name || 'You'}</p>
                  </div>
