...
import {
  ...
  getRarityColor
} from '@/features/drops/utils/rarityHelpers';
        ...
        <div className={`relative ${sizeClasses[size]} flex items-center justify-center`}>
          {currentImage ? (
            <img
              ...
              className={`w-full h-full object-contain transition-all duration-200 ${isAnimating ? 'animate-pulse scale-110' : 'scale-100'
                }`}
            />
          ) : (
