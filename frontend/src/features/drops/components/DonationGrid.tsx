...
const QUALITY_CONFIGS: QualityConfig[] = [
  { id: 'common', label: 'ќбычный', color: '#6B7280', image: CommonClosed },
  { id: 'rare', label: '–едкий', color: '#3B82F6', image: RareClosed },
  { id: 'epic', label: 'Ёпический', color: '#8B5CF6', image: EpicClosed },
  { id: 'legendary', label: 'Ћегендарный', color: '#F59E0B', image: LegendaryClosed }
];
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">ќт {value}?</p>
                  </div>
                </div>
