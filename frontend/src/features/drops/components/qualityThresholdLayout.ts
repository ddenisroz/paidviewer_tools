...
export const QUALITY_THRESHOLD_IMAGE_CLASS = 'h-8 w-8 flex-shrink-0 object-contain';

export const QUALITY_THRESHOLD_INPUT_CLASS =
    'h-8 w-20 border-0 bg-transparent text-center text-sm font-semibold [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none';
