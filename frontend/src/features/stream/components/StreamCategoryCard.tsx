...
const StreamCategoryCard: React.FC<StreamCategoryCardProps> = ({ onLinkStateChange }) => {
    ...
    // ANTI-FLASH: ���������� useMemo ��� ���������� isLinked �������� �� combineCategories
    // ��� �����������, ��� �������� ������ ���������������� � ��� �������� ������������
    ...
    // ANTI-FLASH: ���������� ������������ ��������� �� ��������� isLinked
    // isLinked ������ ����������� �������� �� combineCategories ����� useMemo, ������� ��� �������� ������������
    useEffect(() => {
            ...
            if (value && bothEnabled) {
                ...
                if (twitchCategory) {
                    ...
                    if (vkCategory) {
                        ...
                        // ����������� �� �������� �����������������
                        toast.success(`��������� ����������������: Twitch > VK Live (${vkCategory.name})`);
                        ...
                        // ����������� ��� VK ��������� �� �������
                        toast.warning(`VK Live ��������� ��� "${twitchCat.name}" �� �������. ��������� ������ Twitch ���������.`);
    ...
    const handleCategorySelect = async (platform: string, category: Category) => {
        ...
        if (isLinked && bothEnabled) {
            ...
            if (mappedCategory) {
                ...
                // ����������� �� �������� �������������
                toast.success(`��������� ����������������: ${category.name} > ${mappedCategory.name}`);
            } else {
                // �� ����� ��������������� ��������� - �� ��������!
                // ������������ ����� ������� ������� ��������� �� ������ ���������
                ...
                toast.warning(`��������� "${category.name}" ��������� ������ �� ${platformNames[platform]}. ��� ${platformNames[otherPlatform]} ��������� �� ������� � �������� �������.`);
            }
        } else {
    ...
    const handleSave = (mode: 'both' | 'individual') => {
        ...
        if (mode === 'both') {
            ...
            if (vkEnabled && getCatId(currentData.vk?.category) !== getCatId(initialData.vk?.category)) {
                ...
                // ������: ���������, ��� ��� �� Twitch ID (UUID vs numeric string)
                // VK ID - UUID � �������� (��������, "08c87647-7076-4e2c-8e1b-bc695c78728a")
                // Twitch ID - �������� string (��������, "1469308723")
                ...
                if (!isVkUUID && vkCat?.id) {
                    ...
                    payload.vk = {
                        ...
                        category_id: vkCat?.id || null // Fallback ��� �������������
                    };
                }
            }
        } else {
    ...
    return (
        <Card className="flex flex-col overflow-hidden" style={cardStyle}>
            <CardHeader className="flex-shrink-0 pb-3"><CardTitle className="flex items-center gap-2"><Tag className="h-5 w-5 text-green-500" /> ����� ���������</CardTitle></CardHeader>
            ...
            {isDataLoaded && hasAnyIntegration && (
                <div className="p-3 pt-0 flex-shrink-0">
                    ...
                    >
                        ...
                        {status.saveCategory === 'loading' ? '����������...' : status.saveCategory === 'success' ? '���������' : '���������'}
                    </Button>
                </div>
            )}
        </Card>
