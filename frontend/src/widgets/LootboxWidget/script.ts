...
class LootboxWidget {
  ...
  private getRandomReward(rarity: Rarity): string {
    const rewards: Record<Rarity, string[]> = {
      common: ['100 баллов', 'Обычная награда', 'Монета', 'Зелье здоровья', 'Простой предмет', 'Базовое оружие', 'Обычная броня'],
      rare: ['500 баллов', 'Редкая награда', 'Золотая монета', 'Зелье маны', 'Магический предмет', 'Редкое оружие', 'Синяя броня', 'Кристалл'],
      epic: ['1000 баллов', 'Эпическая награда', 'Драгоценный камень', 'Эликсир', 'Легендарный предмет', 'Эпическое оружие', 'Фиолетовая броня', 'Руна силы'],
      legendary: ['5000 баллов', 'Легендарная награда', 'Мифический артефакт', 'Божественный эликсир', 'Уникальный предмет', 'Легендарное оружие', 'Золотая броня', 'Древняя руна'],
    };
