...
import { AlertCircle, Gift, Inbox, Settings, Shield, Trash2 } from 'lucide-react';
...
import { BotManagementCard } from '@/features/admin/components/BotManagementCard';
                        ...
                        <Card className="flex flex-col gap-3 p-4">
                            <div className="flex items-center justify-between">
                                ...
                                {daConnected ? (
                                    <Switch
                                        checked={daConnected}
                                        onCheckedChange={(checked) => !checked && handleDonationAlertsDisconnect()}
                                    ...
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={handleDonationAlertsConnect}
                                        disabled={daLoading || !hasMainIntegration}
                                    >
                                        Подключить
                                    </Button>
                            ...
                            {!hasMainIntegration && !daConnected && (
                                <div className="flex items-center gap-1.5 text-xs px-2 py-1.5 rounded bg-yellow-500/10 text-yellow-500">
                                    <AlertCircle className="w-3 h-3" />
                                    <span>Требуется Twitch или VK</span>
                                </div>
                            )}
                        </Card>
                    </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                <button
                                    ...
                                    className={`p-4 rounded-lg border-2 transition-all ${ttsPreference === 'pause'
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-lg border-2 transition-all ${ttsPreference === 'duck'
                                        ? 'border-primary bg-primary/10'
                                        : 'border-gray-700 hover:border-gray-600'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-lg border-2 transition-all ${ttsPreference === 'none'
                                        ? 'border-primary bg-primary/10'
                                        : 'border-gray-700 hover:border-gray-600'
                                        }`}
                                >
