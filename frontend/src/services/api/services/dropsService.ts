...
export const dropsService = {
   ...
   * @returns Promise с ответом API
   */
  async updateConfig(channelName: string, config: Partial<DropsConfig>): Promise<AxiosResponse<ApiResponse<DropsConfig>>> {
   ...
   * @returns Promise с ответом API
   */
  async createReward(channelName: string, reward: Partial<DropsReward>): Promise<AxiosResponse<ApiResponse<DropsReward>>> {
   ...
   * @returns Promise с ответом API
   */
  async updateReward(channelName: string, rewardId: number, reward: Partial<DropsReward>): Promise<AxiosResponse<ApiResponse<DropsReward>>> {
