...
interface OptimisticMutationOptions<TData, TError, TVariables, TContext> 
  extends Omit<UseMutationOptions<TData, TError, TVariables, TContext>, 'onMutate' | 'onSuccess' | 'onError' | 'onSettled'> {
  /**
...
export const useOptimisticMutation = <TData = unknown, TError = unknown, TVariables = void, TContext = unknown>(
  ...
  const mutation = useMutation<TData, TError, TVariables, TContext & { previousData?: unknown }>({
    ...
    onError: (error: TError, variables: TVariables, context: TContext & { previousData?: unknown } | undefined) => {
      // Rollback on error
    ...
    onSettled: (data: TData | undefined, error: TError | null, variables: TVariables, context: TContext & { previousData?: unknown } | undefined) => {
