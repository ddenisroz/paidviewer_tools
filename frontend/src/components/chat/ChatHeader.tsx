      ...
      <TooltipProvider>
        <div className="flex items-center gap-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className={cn(buttonBase, 'text-gray-400 border-gray-600 hover:text-blue-400 hover:border-blue-600 hover:bg-blue-600/10')}
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                className={cn(buttonBase, 'text-gray-400 border-gray-600 hover:text-green-400 hover:border-green-600 hover:bg-green-600/10')}
              >
          ...
          <Tooltip>
            ...
            <TooltipContent>
              {chatMessagesVisible ? 'Скрыть чат' : 'Показать чат'}
            </TooltipContent>
          </Tooltip>
        </div>
      </TooltipProvider>
