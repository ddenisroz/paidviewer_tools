...
export const TtsFallback: React.FC<{ onRetry?: () => void }> = ({ onRetry }) => (
  <Card>
    <CardHeader>
      ...
      <CardDescription>
        Произошла ошибка при загрузке TTS системы
      </CardDescription>
    </CardHeader>
    <CardContent>
      {onRetry && (
...
export const DropsFallback: React.FC<{ onRetry?: () => void }> = ({ onRetry }) => (
  <Card>
    <CardHeader>
      ...
      <CardDescription>
        Произошла ошибка при загрузке системы дропов
      </CardDescription>
    </CardHeader>
    <CardContent>
      {onRetry && (
...
export const YouTubeFallback: React.FC<{ onRetry?: () => void }> = ({ onRetry }) => (
  <Card>
    <CardHeader>
      ...
      <CardDescription>
        Произошла ошибка при загрузке YouTube интеграции
      </CardDescription>
    </CardHeader>
    <CardContent>
      {onRetry && (
...
export const PointsFallback: React.FC<{ onRetry?: () => void }> = ({ onRetry }) => (
  <Card>
    <CardHeader>
      ...
      <CardDescription>
        Произошла ошибка при загрузке системы поинтов
      </CardDescription>
    </CardHeader>
    <CardContent>
      {onRetry && (
...
export const CommandsFallback: React.FC<{ onRetry?: () => void }> = ({ onRetry }) => (
  <Card>
    <CardHeader>
      ...
      <CardDescription>
        Произошла ошибка при загрузке системы команд
      </CardDescription>
    </CardHeader>
    <CardContent>
      {onRetry && (
