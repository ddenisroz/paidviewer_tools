...
export const rewardSchema = z.object({
  ...
  repair_timeout: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
    .max(86400, 'Максимум 24 часа (86400 секунд)')
    .optional()
    .default(0),
  max_uses_count: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
    .optional()
    .default(0),
  max_uses_count_per_user: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
    .optional()
    .default(0),
  is_message_required: z.boolean().optional().default(false),
  global_cooldown_seconds: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
    .max(86400, 'Максимум 24 часа (86400 секунд)')
    .optional()
    .default(0),
  max_per_stream: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
    .optional()
    .default(0),
  max_per_user_per_stream: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
    .optional()
    .default(0),
...
export const commandSchema = z.object({
  ...
  response_text: z.string()
    ...
    .max(500, 'Максимум 500 символов')
    .trim(),
  cooldown_seconds: z.coerce.number()
    .int('Должно быть целое число')
    .min(0, 'Не может быть отрицательным')
...
export const streamCategorySchema = z.object({
  category_id: z.string()
    ...
    .max(100, 'ID категории слишком длинный'),
  category_name: z.string()
    .max(200, 'Название категории слишком длинное')
    .optional(),
  platform: z.enum(['twitch', 'vk']),
});
...
export const youtubeSettingsSchema = z.object({
  ...
  api_key: z.string()
    ...
    .max(200, 'API ключ слишком длинный')
    .optional(),
