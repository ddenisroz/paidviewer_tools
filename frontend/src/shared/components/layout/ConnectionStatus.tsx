    ...
    <div className="fixed bottom-4 left-4 z-50 group">
      <div
        className={`
          ...
          cursor-help shadow-sm backdrop-blur-md
      ...
      >
        ...
        <span
          className="text-xs font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 delay-75 max-w-0 group-hover:max-w-[200px]"
        >
          {text}
        </span>
      </div>
