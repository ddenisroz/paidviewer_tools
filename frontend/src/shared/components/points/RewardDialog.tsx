...
const createInitialFormData = (reward: PlatformReward | null): RewardFormData => {
    ...
    return {
        ...
        max_uses_count_per_user: pickValue([reward.max_uses_count_per_user], DEFAULT_REWARD_FORM_DATA.max_uses_count_per_user),
        ...
        max_per_user_per_stream: pickValue([reward.max_per_user_per_stream], DEFAULT_REWARD_FORM_DATA.max_per_user_per_stream),
