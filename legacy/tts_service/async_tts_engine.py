# tts_service/async_tts_engine.py
import asyncio
import logging
import time
import os
...
class AsyncTTSEngine:
    ...
    def _init_tts_engine(self) -> RussianTTS:
        """Инициализация TTS движка в отдельном потоке"""
        try:
            engine = RussianTTS()
    ...
    async def synthesize_speech_async(
        ...
        task = SynthesisTask(
            ...
            channel=channel or f"user_{user_id}",
            platform=platform,
            priority=priority,
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            **self.stats,
            ...
            'max_concurrent_synthesis': self.max_concurrent_synthesis
        }
