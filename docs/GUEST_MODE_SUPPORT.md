...
**Почему:**
- Гости не могут стримить (нет канала Twitch/VK)
- YouTube очередь привязана к `user_id` владельца канала
- Нет смысла добавлять видео в несуществующий стрим

**Альтернатива:** Нет (это логично)

---

### 2. **Управление стримом** ❌
